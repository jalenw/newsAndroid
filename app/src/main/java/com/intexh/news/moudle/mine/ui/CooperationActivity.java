...
public class CooperationActivity extends AppBaseActivity {
    ...
    public void initView() {
        super.initView();
        MobclickAgent.onEvent(mContext,"bussiness");
    }
        ...
        NetworkManager.INSTANCE.post(Apis.aboutUs, params, new NetworkManager.OnRequestCallBack() {
            ...
            public void onOk(String response) {
                ...
                if (ValidateUtils.isValidate(cooperationBean)) {
                    ...
                    phone1Tv.setText(ValidateUtils.isValidate(cooperationBean.getSwphone()) ? cooperationBean.getSwphone() : "");
                    phone2Tv.setText(ValidateUtils.isValidate(cooperationBean.getSwtel()) ? cooperationBean.getSwtel() : "");
                    contentTv.setText(cooperationBean.getContactus());
                }
            }
