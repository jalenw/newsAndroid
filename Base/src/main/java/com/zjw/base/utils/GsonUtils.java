...
public class GsonUtils {
    ...
    public static JsonObject parseJson(String json) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "parseJson Exception===" + e.toString());
        }
        return jsonObj;
    }
    ...
    public static <T> T jsonToBean(String str, Class<T> type) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "jsonToBean Exception===" + e.toString()+"\n"+str);
    ...
    public static String getStringFromJSON(String json, String key1, String key2) {
        ...
        try {
            ...
            e.printStackTrace();
            LogCatUtil.e("frank", "getStringFromJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static long getLongFormJSON(String json, String key1, String key2) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getLongFormJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static boolean getBooleanFormJSON(String json, String key1, String key2) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getBooleanFormJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static String getStringFromJSON(String json, String key) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getStringFromJSON Exception==="+"\n"+ e.toString()+"json="+json+"\nkey="+key);
        }
        return data;
    }
    ...
    public static int getStatusFromJSON(String json) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getStatusFromJSON Exception===" + e.toString());
        }
        return status;
    }
    ...
    public static String getMessageFromJSON(String json) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getMessageFromJSON Exception===" + e.toString());
        }
        return message;
    }
    ...
    public static int getErrorCodeFromJSON(String json) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getErrorCodeFromJSON Exception===" + e.toString());
        }
        return status;
    }
    ...
    public static int getCodeFromJSON(String json) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getCodeFromJSON Exception===" + e.toString());
        }
        return status;
    }
    ...
    public static String getErrorStringFromJSON(String json) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getErrorStringFromJSON Exception===" + e.toString());
        }
        return err_str;
    }
    ...
    public static long getLongFromJsonData(String json, String key) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getLongFromJsonData Exception===" + e.toString());
        }
        return value;
    }
    ...
    public static int getIntFromJsonData(String json, String key) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getIntFromJsonData Exception===" + e.toString());
        }
        return value;
    }
    ...
    public static String getStringFromJsonData(String json, String key) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getStringFromJsonData Exception=== key=" + key + " == " + e.toString());
        }
        return value;
    }
    ...
    public static int getIntFromJSON(JSONObject obj, String key) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getIntFromJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static long getLongFromJSON(String json, String key) {
        ...
        try {
            ...
            LogCatUtil.e("frank", "getLongFromJSON Exception===" + e.toString());
        }
        return data;
    }
    ...
    public static <T> List<T> jsonToBeanList(String json,String key,Type tClass) {
        ...
        if (data == null || TextUtils.isEmpty(data)) { // json data 字段为空
            ...
            try {
                ...
                LogCatUtil.e("frank", "jsonToBeanList Exception===" + e.toString());
            }
        }
        return new ArrayList<T>();
    }
    ...
    public static <T> List<T> jsonToBeanList(String json, String key1, String key2, Type tClass) {
        ...
        if (data == null || TextUtils.isEmpty(data)) { // json data 字段为空
            ...
            try {
                ...
                LogCatUtil.e("frank", "jsonToBeanList Exception===" + je.toString());
            }
        }
        return new ArrayList<T>();
    }
